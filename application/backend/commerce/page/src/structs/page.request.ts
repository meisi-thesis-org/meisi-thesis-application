...
type CreatePageRequest = NonNullable<Readonly<Pick<PageEntity, 'chapterUuid' | 'designation' | 'description'>>>
type UpdatePageByUuidRequest =
    NonNullable<Pick<PageEntity, 'uuid'>> &
    Partial<Readonly<Pick<PageEntity, 'designation' | 'description' | 'visible' | 'active'>>>
