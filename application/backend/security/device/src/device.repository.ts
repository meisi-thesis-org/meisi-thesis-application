...
export interface DeviceRepository {
  findDevicesByUserUuid(userUuid: string | undefined): Promise<DeviceDTO[]>
  ...
  updateDeviceByUuid(uuid: string, deviceEntity: Omit<DeviceEntity, 'uuid' | 'userUuid' | 'createdAt'>): Promise<void>
}
